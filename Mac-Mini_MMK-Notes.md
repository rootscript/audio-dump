...
I use them for high voltage tube supplies, but not for low voltage supplies. The SiC diodes have a much higher voltage drop than "regular" Schottkys. You can get regular Schottkys up to 100V rating, the only reason i would go with the Creess is if you need more than 100V.
John S.
